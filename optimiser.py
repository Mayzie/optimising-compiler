...
if __name__ == "__main__":
    ...
    arg_parse = argparse.ArgumentParser(prog = "ir_optimise",
                                     description = "Optimises *correct* intermediate representation programs generated by the COMP3109 Assignment 2 compiler",
                                     epilog = "COMP3109 - Assignment 3 (Elie Moreau, Daniel Collis)")
    arg_parse.add_argument("-i", "--input", type = str, help = "REQUIRED: Input IR file", required = True)
