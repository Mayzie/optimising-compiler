...
if __name__ == "__main__":
    ...
    arg_parse = argparse.ArgumentParser(prog = "ir_optimise",
                                     description = "Optimises intermediate representation programs generated by the COMP3109 Assignment 2 compiler",
                                     epilog = "COMP3109 - Assignment 2 (Elie Moreau, Daniel Collis)")
